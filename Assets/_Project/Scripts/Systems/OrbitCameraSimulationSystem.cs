	...
	public partial struct OrbitCameraSimulationSystem : ISystem
	{
		...
		public partial struct OrbitCameraSimulationJob : IJobEntity
		{
			                     ...
			                     in OrbitCameraControl cameraControl)
			{
				...
				OrbitCameraUtilities.CalculateCameraRotation(ref targetUp, ref orbitCameraComponent.PlanarForward,
				...
				OrbitCameraUtilities.CalculateCameraPosition(ref targetPosition, ref cameraRotation,
				                                             orbitCameraComponent.TargetDistance, out float3 cameraPosition);
